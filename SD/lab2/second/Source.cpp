...
void DeleteNode(PNode& Head, PNode OldNode)
{
    PNode q = Head;
    if (Head == OldNode)
        Head = OldNode->next; // удал€ем первый элемент
    else {
    ...
    delete OldNode; // освобождаем пам€ть
}
    ...
    while (true)
    {
        ...
        case 4:
            ...
            if (p == NULL)
                ...
                cout << "узел с значение " << x << " имеетс€ в списке, его ключ " << p->count << "\n";
            system("PAUSE");
            system("cls");
            break;
        ...
        case 6:
            int n;
            PrintNodeKey(Head);
            cout << "количество элементов которые надо удалить и значение элемента с каторого начать удал€ть\n";
            cin >> n >> x;
            p = Find(Head, x);
        ...
        case 8:
            for (int i = 0; i < len1; i++) {
                ...
                if (2022 - whereJ->birthday.year > 40) {
                    cout << whereJ->LastName << "—тарше 40 лет\n";
                }
                pJ = whereJ;
            }
            system("PAUSE");
        ...
        case 11:
            ...
            break;
        case 12:
            cout << "‘амили€, название работы, зарплата, день, мес€ц, год рождени€\n";
